...
void HttpSession::HttpProcess(const HttpRequestContext &httprequestcontext, std::string &responsecontext)
{
   ...
   // std::cout << "httprequestcontext.method="<<httprequestcontext.method << std::endl;
     //std::cout << "httprequestcontext.url="<<httprequestcontext.url << std::endl;
      //std::cout << "httprequestcontext.body="<<httprequestcontext.body << std::endl;
   // std::cout<<"path="<<path<<std::endl;

    if("GET" == httprequestcontext.method&&path!="/hello")
    {
        HttpMethodGet(httprequestcontext, responsecontext, path);
	    return;
    }
    else if("POST" == httprequestcontext.method)
    {
        HttpMethodPost(httprequestcontext, responsecontext, path);
	return;
    }
    else
    {
